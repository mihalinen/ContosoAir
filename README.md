[![Build Status](https://dev.azure.com/mihalinen/ContosoAir/_apis/build/status/mihalinen.ContosoAir?branchName=master)](https://dev.azure.com/mihalinen/ContosoAir/_build/latest?definitionId=2&branchName=master)
